...
<head>
    ...
    <title>@lang('Gestión Documental')</title>
    ...
    <link href="{{asset('adminTemplate/css/sb-admin-2.css')}}" rel="stylesheet">
    <link href="{{asset('adminTemplate/css/elementor.css')}}" rel="stylesheet">
           ...
           @if (auth()->user()->rol == 'Super')
            ...
            <!--li class="nav-item">
                <a class="nav-link collapsed" href="{{route('admin.tiposTs')}}" data-target="#collapsePages"
                    aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>@lang('Tipos de Documento')</span>
                </a>
            </li-->
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">Tiene un nuevo vencimiento!</span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        ...
                                        Tiene una nueva renovación de contrato!
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Octubre 2, 2022</div>
                                        Tiene acciones pendientes por realizar.
                                    </div>
                                </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{auth()->user()->name}} ({{auth()->user()->rol}}</span>
